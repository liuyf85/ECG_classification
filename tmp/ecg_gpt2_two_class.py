...
def prosess_data():
    ...
    labels_tensor = (labels_tensor != 0).to(torch.long)
...
class GPT2(nn.Module):
    def __init__(self, input_size, hidden_size, num_labels, n_heads, n_layers, n_inter):
        ...
        self.conv2 = nn.Conv1d(in_channels=hidden_size//2, out_channels=hidden_size, kernel_size=5, padding=3)
...
for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)):
    ...
    # output_path = f"confusion_matrix_fold_{fold + 1}.png"
